...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.slide.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-3">
                    <img src="https://placehold.co/600x400?text=Hello+World" alt="" class="w-100 p-5">
                </div>
                <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="offer" name="offer" placeholder="Enter offer"  value="{{ old("offer") }}">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="button_link" name="button_link" placeholder="Enter button link" value="{{ old("button_link") }}">
                    </div>
