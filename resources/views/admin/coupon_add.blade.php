            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="min_purchase_amount" name="min_purchase_amount" placeholder="Enter Amount" value="{{ old("min_purchase_amount") }}">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input 
                            value="{{ old("expire_date", date('Y-m-d')) }}"
                            min="{{ date('Y-m-d') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <select id="discount_type" name="discount_type" class="form-control select2">
                            ...
                            @foreach(["percent","amount"] as $type)
                                <option @if(old("discount_type") == $type) selected @endif value="{{ $type }}">
