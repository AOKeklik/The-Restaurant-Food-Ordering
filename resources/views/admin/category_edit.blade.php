...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.product.category.update") }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("POST")
            <input type="hidden" name="category_id" value="{{ request()->route("category_id") }}">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input readonly type="text" class="form-control" id="slug" name="slug" value="{{ $category->slug }}" placeholder="Enter slug">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="type" class="form-control select2">
                            <option value=""></option>
                            <option @if($category->type === "product") selected @endif value="product">Product</option>
                            <option @if($category->type === "page") selected @endif value="page">Page</option>
                            <option @if($category->type === "menu") selected @endif value="menu">Menu</option>
                        </select>
